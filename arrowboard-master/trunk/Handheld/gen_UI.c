...
funcPeriodic *periodicIDToFunction(int nID)
{
	...
	switch(nID)
	{
		...
		case PERIODIC_FUNCTION_ID_CheckSystemCurrentTensDigit:
			...
			break;
		case PERIODIC_FUNCTION_ID_CheckStatusArrowBoardType:
			pRetVal = (funcPeriodic*)CheckStatusArrowBoardType;
			break;
		case PERIODIC_FUNCTION_ID_CheckStatusStyleType:
			pRetVal = (funcPeriodic*)CheckStatusStyleType;
			break;
		case PERIODIC_FUNCTION_ID_CheckStatusElectricActuatorType:
			pRetVal = (funcPeriodic*)CheckStatusElectricActuatorType;
			break;
		case PERIODIC_FUNCTION_ID_CheckSystemVoltageTensDigit:
			pRetVal = (funcPeriodic*)CheckSystemVoltageTensDigit;
			break;
		case PERIODIC_FUNCTION_ID_CheckSystemVoltageOnesDigit:
			pRetVal = (funcPeriodic*)CheckSystemVoltageOnesDigit;
			break;
		case PERIODIC_FUNCTION_ID_CheckSystemVoltageTenthsDigit:
			pRetVal = (funcPeriodic*)CheckSystemVoltageTenthsDigit;
			break;
		case PERIODIC_FUNCTION_ID_CheckStatusVoltageScreen:
			pRetVal = (funcPeriodic*)CheckStatusVoltageScreen;
			break;
		case PERIODIC_FUNCTION_ID_CheckImageAlarmState:
			pRetVal = (funcPeriodic*)CheckImageAlarmState;
			break;
		case PERIODIC_FUNCTION_ID_CheckImageVoltageState:
			pRetVal = (funcPeriodic*)CheckImageVoltageState;
			break;
		case PERIODIC_FUNCTION_ID_CheckImageSystemState:
			pRetVal = (funcPeriodic*)CheckImageSystemState;
			break;
		case PERIODIC_FUNCTION_ID_CheckImageAlarmLevelConnLowBatt:
			pRetVal = (funcPeriodic*)CheckImageAlarmLevelConnLowBatt;
			break;
		case PERIODIC_FUNCTION_ID_CheckImageAlarmLevelLowVoltage:
			pRetVal = (funcPeriodic*)CheckImageAlarmLevelLowVoltage;
			break;
		case PERIODIC_FUNCTION_ID_CheckImageAlarmLevelLampsDisabled:
			pRetVal = (funcPeriodic*)CheckImageAlarmLevelLampsDisabled;
			break;
		case PERIODIC_FUNCTION_ID_CheckImageAlarmLevelTempHigh:
			pRetVal = (funcPeriodic*)CheckImageAlarmLevelTempHigh;
			break;
		case PERIODIC_FUNCTION_ID_CheckStatusConfigScreen:
			pRetVal = (funcPeriodic*)CheckStatusConfigScreen;
			break;
		case PERIODIC_FUNCTION_ID_CheckEnabledConnect:
			pRetVal = (funcPeriodic*)CheckEnabledConnect;
			break;
		case PERIODIC_FUNCTION_ID_checkImageDriverVersion1:
			pRetVal = (funcPeriodic*)checkImageDriverVersion1;
			break;
		case PERIODIC_FUNCTION_ID_checkImageDriverVersion2:
			pRetVal = (funcPeriodic*)checkImageDriverVersion2;
			break;
		case PERIODIC_FUNCTION_ID_checkImageDriverVersion3:
			pRetVal = (funcPeriodic*)checkImageDriverVersion3;
			break;
		case PERIODIC_FUNCTION_ID_checkImageDriverVersion4:
			pRetVal = (funcPeriodic*)checkImageDriverVersion4;
			break;
		case PERIODIC_FUNCTION_ID_checkImageDriverVersion5:
			pRetVal = (funcPeriodic*)checkImageDriverVersion5;
			break;
		case PERIODIC_FUNCTION_ID_checkRssiDigit1:
			pRetVal = (funcPeriodic*)checkRssiDigit1;
			break;
		case PERIODIC_FUNCTION_ID_checkRssiDigit2:
			pRetVal = (funcPeriodic*)checkRssiDigit2;
			break;
		default:
			break;
	}
...
funcPushbutton *pushbuttonIDToFunction(int nID)
{
	...
	switch(nID)
	{
		...
		case PUSHBUTTON_FUNCTION_ID_Actuator180NeutralPress:
			...
			break;
		case PUSHBUTTON_FUNCTION_ID_DoSelectStandardScreen:
			pRetVal = (funcPushbutton*)DoSelectStandardScreen;
			break;
		case PUSHBUTTON_FUNCTION_ID_DoSelectSingleScreen:
			pRetVal = (funcPushbutton*)DoSelectSingleScreen;
			break;
		default:
			break;
	}
...
funcWhichImagebutton *whichImageIDToFunction(int nID)
{
	...
	switch(nID)
	{
		...
		case WHICHIMAGE_FUNCTION_ID_WhichImageDriverVersionDigit5:
			...
			break;
		case WHICHIMAGE_FUNCTION_ID_WhichImageSelectedStandardMain:
			pRetVal = (funcWhichImagebutton*)WhichImageSelectedStandardMain;
			break;
		case WHICHIMAGE_FUNCTION_ID_WhichImageSelectedSingleMain:
			pRetVal = (funcWhichImagebutton*)WhichImageSelectedSingleMain;
			break;
		case WHICHIMAGE_FUNCTION_ID_WhichImageStatusElectricActuatorButton:
			...
			break;
		case WHICHIMAGE_FUNCTION_ID_WhichSystemVoltageTensDigit:
			pRetVal = (funcWhichImagebutton*)WhichSystemVoltageTensDigit;
			break;
		case WHICHIMAGE_FUNCTION_ID_WhichSystemVoltageOnesDigit:
			pRetVal = (funcWhichImagebutton*)WhichSystemVoltageOnesDigit;
			break;
		case WHICHIMAGE_FUNCTION_ID_WhichSystemVoltageTenthsDigit:
			pRetVal = (funcWhichImagebutton*)WhichSystemVoltageTenthsDigit;
			break;
		case WHICHIMAGE_FUNCTION_ID_WhichImageRssiDigit1:
			pRetVal = (funcWhichImagebutton*)WhichImageRssiDigit1;
			break;
		case WHICHIMAGE_FUNCTION_ID_WhichImageRssiDigit2:
			pRetVal = (funcWhichImagebutton*)WhichImageRssiDigit2;
			break;
		default:
			break;
	}
